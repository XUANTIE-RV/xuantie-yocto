...
DEPENDS_GOLANG:class-target = "virtual/${TUNE_PKGARCH}-goxuantie virtual/${TARGET_PREFIX}goxuantie-runtime"
DEPENDS_GOLANG:class-native = "goxuantie-native"
DEPENDS_GOLANG:class-nativesdk = "virtual/${TARGET_PREFIX}goxuantie-crosssdk virtual/${TARGET_PREFIX}goxuantie-runtime"
...
goxuantie_do_configure() {
	ln -snf ${S}/src ${B}/
}
do_configure[dirs] =+ "${GOTMPDIR}"

goxuantie_do_compile() {
