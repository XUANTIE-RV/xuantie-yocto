...
DEPENDS = "nasm-native libomxil libdrm"
DEPENDS += "${@bb.utils.contains('MACHINECONFIG','public','th1520-bsp-proprietary','vpu-omxil',d)}"

inherit autotools pkgconfig

PACKAGECONFIG ??= "avdevice avfilter avcodec avformat swresample swscale postproc \
                   alsa bzlib lzma openh264 pic pthreads shared theora zlib \
