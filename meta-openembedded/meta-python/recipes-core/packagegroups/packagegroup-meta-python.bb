...
'
# Removed packages below to prevent the entire installation
# bitbake error: python3-pybind11-json but it is not installable
#                python3-pyconnman but it is not going to be installed
