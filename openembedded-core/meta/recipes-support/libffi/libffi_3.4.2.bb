...
EXTRA_OECONF += "--disable-builddir --disable-exec-static-tramp --enable-static=yes"
...
do_install:append:class-target() {
	if [ -f ${B}/.libs/libffi_convenience.a ]; then
		install -m 644 ${B}/.libs/libffi_convenience.a ${D}/usr/lib/libffi_pic.a
	fi
}
